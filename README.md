...
| Module | What it does |
| --- | --- |
| `Drug Information` | ค้นหาและเปิดดูรายละเอียดของยา พร้อมรูปยา route สถานะ และข้อมูล injection |
...
- sidebar แสดงลิงก์ `Drug Information` และ `IV Compatibility`
...
/formulary        -> หน้า Drug Information
